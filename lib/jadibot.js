...
const { smsg, isUrl, generateMessageTag, getBuffer, getSizeMedia, fetchJson, await, sleep, reSize } = require('./myfunc3')
...
browser: ['elainav5-jadibot', "Safari", "1.0.0"],
...
if (connection){
if (connection != "connecting") console.log("Connecting to elainav5-jadibot..")
}
