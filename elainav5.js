...
XeonBotInc.sendMessage(from, { text: `Shut Up, never been taught how to speak?!`, quoted: fkontak})
//Fake
	    const ftroli3 = {key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 2022,status: 200, thumbnail: thumb, surface: 200, message: botname, orderTitle: ownername, sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
		const fdoc3 = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {documentMessage: {title: botname,jpegThumbnail: thumb}}}
		const fvn3 = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds":359996400,"ptt": "true"}} } 
		const fgif3 = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: {"videoMessage": { "title":botname, "h": wm,'seconds': '359996400', 'gifPlayback': 'true', 'caption': ownername, 'jpegThumbnail': thumb}}}
		const fgclink3 = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": wm, "caption": `${pushname}`, 'jpegThumbnail': thumb}}}
		const fvideo3 = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {}) },message: { "videoMessage": { "title":botname, "h": wm,'seconds': '359996400', 'caption': `${pushname}`, 'jpegThumbnail': thumb}}}
		const floc3 = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: wm,jpegThumbnail: thumb}}}
		const fkontak3 = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': ownername, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${ownername},;;;\nFN:${ownername}\nitem1.TEL;waid=916909137213:916909137213\nitem1.X-ABLabel:Mobile\nEND:VCARD`, 'jpegThumbnail': thumb, thumbnail: thumb,sendEphemeral: true}}}
...
jumlahharian = `${dataa.value}`
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await XeonBotInc.setStatus(`Hello there, type menu to go! | ${XeonBotInc.user.name} | ${xdate} Bot Runtime : 66666${run}`)
...
XeonBotInc.sendMessage(from, {text:`\`\`\`「 Group Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:fkontak3})
} else {
}
}
  // Antiwame by xeon
...
XeonBotInc.sendMessage(from, {text:`\`\`\`「 Wa.me Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending youtube video link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:fkontak3})
} else {
}
  if (antiWame)
...
kice = m.sender
await XeonBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
XeonBotInc.sendMessage(from, {text:`\`\`\`「 Bad Word Detected 」\`\`\`\n\n@${kice.split("@")[0]} was kicked because of using bad words in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:fkontak3})}
}
...
kice = m.sender
await XeonBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
XeonBotInc.sendMessage(from, {text:`\`\`\`「 YouTube Channel Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending youtube channel link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:fkontak3})
} else {
}
...
kice = m.sender
await XeonBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
XeonBotInc.sendMessage(from, {text:`\`\`\`「 Instagram Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending instagram link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:fkontak3})
} else {
}
...
kice = m.sender
await XeonBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
XeonBotInc.sendMessage(from, {text:`\`\`\`「 Facebook Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending facebook link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:fkontak3})
} else {
}
...
kice = m.sender
await XeonBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
XeonBotInc.sendMessage(from, {text:`\`\`\`「 Telegram Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending telegram link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:fkontak3})
} else {
}
...
kice = m.sender
await XeonBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
XeonBotInc.sendMessage(from, {text:`\`\`\`「 Tiktok Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending tiktok link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:fkontak3})
} else {
}
...
kice = m.sender
await XeonBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
XeonBotInc.sendMessage(from, {text:`\`\`\`「 Tiktok Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending twitter link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:fkontak3})
} else {
}
...
XeonBotInc.sendMessage(from, buttonMessage, {quoted:fkontak3})
})
} catch (e) {
...
Typed *surrender* to surrender and admited defeat`
	    ...
	    XeonBotInc.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} Refuse Suit, Suit Canceled`, fkontak3)
...
Click https://wa.me/${botNumber.split`@`[0]}`, m, { mentions: [roof.p, roof.p2] })
	    ...
	    XeonBotInc.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} Didn't Choose Suit, Game Over!`, fkontak3)
	    }
	    delete this.suit[roof.id]
	    return !0
	    }, roof.timeout)
...
XeonBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nThe bot has been disabled in this group, now no one will able to use the bot in this group!`, contextInfo: { mentionedJid : mems }}, {quoted:fkontak3})
} else if (args[0] === "off") {
...
if (isBanChat) return reply(mess.banChat)
            ...
            if (this.game) {
            delete this.game
            XeonBotInc.sendText(m.chat, `Successfully Deleted The TicTacToe Session`, fkontak3)
            } else if (!this.game) {
...
Please @${m.mentionedJid[0].split`@`[0]} To Type Accept/Reject`
            ...
            status: 'wait',
            waktu: setTimeout(() => {
            if (this.suit[id]) XeonBotInc.sendText(m.chat, `_Suit Time Out_`, fkontak3)
            delete this.suit[id]
...
if (isBanChat) return reply(mess.banChat)
                ...
                _family100['family100'+m.chat] = {
                    id: 'family100'+m.chat,
                    pesan: await XeonBotInc.sendText(m.chat, hasil, fkontak3),
                    ...random,
...
if (isBanChat) return reply(mess.banChat)
		if (!m.isGroup) return replay(`${mess.group}`)
            ...
            reply(from, 'Success kick all member', fkontak3)
	case 'demoteall':
		if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
		if (!m.isGroup) return replay(`${mess.group}`)
...
©${XeonBotInc.user.id}
`
XeonBotInc.sendTextWithMentions(m.chat, teks_vote, fkontak3)
break
...
if (isBanChat) return reply(mess.banChat)
                ...
                let buttons = [
                    ...
                    await XeonBotInc.sendButtonText(m.chat, buttons, `Group Mode`, XeonBotInc.user.name, fkontak3)
...
if (isBanChat) return reply(mess.banChat)
             ...
             let buttons = [
                    ...
                    await XeonBotInc.sendButtonText(m.chat, buttons, `Mode Edit Info`, XeonBotInc.user.name, fkontak3)
...
XeonBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nIf you're not an admin, don't send the group link in this group or u will be kicked immediately`, contextInfo: { mentionedJid : mems }}, {quoted:fkontak3})
} else if (args[0] === "off") {
...
XeonBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nIf you're not an admin, don't send the youtube video link in this group or u will be kicked immediately!`, contextInfo: { mentionedJid : mems }}, {quoted:fkontak3})
} else if (args[0] === "off") {
...
XeonBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nIf you're not an admin, don't send the youtube channel link in this group or u will be kicked immediately!`, contextInfo: { mentionedJid : mems }}, {quoted:fkontak3})
} else if (args[0] === "off") {
...
XeonBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nIf you're not an admin, don't send the instagram link in this group or u will be kicked immediately!`, contextInfo: { mentionedJid : mems }}, {quoted:fkontak3})
} else if (args[0] === "off") {
...
XeonBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nIf you're not an admin, don't send the facebook link in this group or u will be kicked immediately!`, contextInfo: { mentionedJid : mems }}, {quoted:fkontak3})
} else if (args[0] === "off") {
...
XeonBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nIf you're not an admin, don't send the telegram link in this group or u will be kicked immediately!`, contextInfo: { mentionedJid : mems }}, {quoted:fkontak3})
} else if (args[0] === "off") {
...
XeonBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nIf you're not an admin, don't send the tiktok link in this group or u will be kicked immediately!`, contextInfo: { mentionedJid : mems }}, {quoted:fkontak3})
} else if (args[0] === "off") {
...
XeonBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nIf you're not an admin, don't send the twitter link in this group or u will be kicked immediately!`, contextInfo: { mentionedJid : mems }}, {quoted:fkontak3})
} else if (args[0] === "off") {
...
XeonBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nIf you're not an admin, don't send any link in this group or u will be kicked immediately!`, contextInfo: { mentionedJid : mems }}, {quoted:fkontak3})
} else if (args[0] === "off") {
...
XeonBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nNo body is allowed to send virus in this group, member who send will be kicked immediately!`, contextInfo: { mentionedJid : mems }}, {quoted:fkontak3})
} else if (args[0] === "off") {
...
XeonBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nNobody is allowed to use bad words in this group, one who uses will be kicked immediately!`, contextInfo: { mentionedJid : mems }}, {quoted:fkontak3})
} else if (args[0] === "off") {
...
XeonBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nNobody is allowed to send wa.me in this group, one who sends will be kicked immediately!`, contextInfo: { mentionedJid : mems }}, {quoted:fkontak3})
} else if (args[0] === "off") {
...
XeonBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nNsfw(not safe for work) feature has been enabled in this group, which means one can access sexual graphics from the bot!`, contextInfo: { mentionedJid : mems }}, {quoted:fkontak3})
} else if (args[0] === "off") {
...
if (isBanChat) return reply(mess.banChat)
                ...
                reply(`${XeonBotInc.user.name} Has Been Unmuted In This Group!`)
                 ...
                 let buttons = [
                    ...
                    await XeonBotInc.sendButtonText(m.chat, buttons, `Mute Bot`, XeonBotInc.user.name, fkontak3)
                }
             }
             break
...
XeonBotInc.sendTextWithMentions(m.chat, teks, fkontak3)
}
break
case 'q': case 'quoted': {
   if (isBan) return reply(mess.ban)	 			
...
*Description* : ${desc}`)
XeonBotInc.sendImage(m.chat, wrpic, winratenya, fkontak3)
...
XeonBotInc.sendMessage(nyz.phoneNumber.split("+")[1] + "@s.whatsapp.net", { image: photoprofile, caption: menfesnya},{quoted:fkontak3})
XeonBotInc.sendImage(m.chat, photoprofile, suksesnya, fkontak3)
break
case 'hitungmundur':
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
XeonBotInc.sendMessage(from, {sticker:fs.readFileSync("gifee.webp")},{quoted:fkontak3})
} else if (/image/.test(mime)) {
let media = await quoted.download()
...
XeonBotInc.sendMessage(from, {image:{url:buffer}, caption:"Here you go!"}, {quoted:fkontak3})
break
...
XeonBotInc.sendMessage(from, {image : nyz3, caption:`By ${global.botname}`}, {quoted:fkontak3}) 						
} catch (e) {
error("Error!")
}
break
...
yag = await getBuffer(anu.url)
XeonBotInc.sendImage(m.chat, yag, mess.success, fkontak3)
break
case 'maid': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!m.isGroup) return replay(mess.group)
reply(mess.wait)
anu = await fetchJson(`https://api.waifu.im/random/?selected_tags=maid`)
yag = await getBuffer(anu.url)
XeonBotInc.sendImage(m.chat, yag, mess.success, fkontak3)
break
case 'waifu2': 
...
.then(({data}) => {
XeonBotInc.sendImage(m.chat, data.url, mess.success, fkontak3)
})
break
case 'milf': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await fetchJson(`https://api.waifu.im/random/?selected_tags=milf`)
yag = await getBuffer(anu.url)
XeonBotInc.sendImage(m.chat, yag, mess.success, fkontak3)
break
case 'nyaoi': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/yuri?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Maaf apikey telah mencapai batas.'))
break
case 'trap2': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/trap?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Maaf apikey telah mencapai batas.'))
break
case 'kitsune': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/hentai?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Maaf apikey telah mencapai batas.'))
break
case 'futanari': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/tentacles?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Maaf apikey telah mencapai batas.'))
break
case 'glasses': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/glasses?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Maaf apikey telah mencapai batas.'))
break
case 'zettai': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/zettai?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Maaf apikey telah mencapai batas.'))
break
case 'bdsm': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/bdsm?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Maaf apikey telah mencapai batas.'))
break
case 'bj': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/blowjob?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Maaf apikey telah mencapai batas.'))
break
case 'girlsolo': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/foot?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Maaf apikey telah mencapai batas.'))
break
case 'feet': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/femdom?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Maaf apikey telah mencapai batas.'))
break
case 'gangbang': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/gangbang?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Maaf apikey telah mencapai batas.'))
break
case 'lesbians': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/masturbation?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Maaf apikey telah mencapai batas.'))
break
case 'hneko': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/nsfw-neko?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Maaf apikey telah mencapai batas.'))
break
case 'panties': 
if (isBan) return reply(mess.ban)	 			
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/nsfw/panties?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Maaf apikey telah mencapai batas.'))
break
case 'trap': 
if (isBan) return reply(mess.ban)	 			
...
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/cecan/china?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Maaf apikey telah mencapai batas.'))
break
case 'cecanthailand': 
if (isBan) return reply(mess.ban)	 			
...
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/cecan/thailand?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Maaf apikey telah mencapai batas.'))
break
...
if (!isRegister) return reply(blomdaftar)
reply(mess.wait)
anu = await getBuffer(`https://api.zeeoneofc.xyz/api/cecan/vietnam?apikey=${zeeone}`)
XeonBotInc.sendMessage(m.chat, { image: anu, caption: mess.success }, { quoted: fkontak}).catch((err) => m.reply('Maaf apikey telah mencapai batas.'))
break
case 'kayes': 
if (isBan) return reply(mess.ban)	 			
...
if (!isRegister) return reply(blomdaftar)
	...
	nama = res.caption
XeonBotInc.sendImage(m.chat, gambar, nama, fkontak3)
	}
            break
case 'megumin': 
if (isBan) return reply(mess.ban)	 			
...
yhta = ytta.image
ykta = ytta.caption
XeonBotInc.sendImage(m.chat, yhta, ykta, fkontak3)
break
case 'paizuri': 
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
	anu = await fetchJson(`https://api.waifu.im/random/?selected_tags=paizuri`)
yag = await getBuffer(anu.url)
XeonBotInc.sendImage(m.chat, yag, mess.success, fkontak3)
break
case 'ero': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await fetchJson(`https://api.waifu.im/random/?selected_tags=ero`)
yag = await getBuffer(anu.url)
XeonBotInc.sendImage(m.chat, yag, mess.success, fkontak3)
break
case 'oral': 
...
if (!AntiNsfw) return reply(mess.nsfw)
reply(mess.wait)
anu = await fetchJson(`https://api.waifu.im/random/?selected_tags=oral`)
yag = await getBuffer(anu.url)
XeonBotInc.sendImage(m.chat, yag, mess.success, fkontak3)
break
case 'nyuri': 
...
let spgif = await GIFBufferToVideoBuffer(spbuff)   
        await XeonBotInc.sendMessage(m.chat,{video: spgif, gifPlayback:true},{ quoted:fkontak3 }).catch(err => {
                    return reply('Error!')
                                    })
break
case 'blowjobgif':
...
let bjif = await GIFBufferToVideoBuffer(bjf)   
        await XeonBotInc.sendMessage(m.chat,{video: bjif, gifPlayback:true},{ quoted:fkontak3 }).catch(err => {
                    return reply('error..')
                                    })
break
...
if (!AntiNsfw) return reply(mess.nsfw)
  ...
  headerType: 1
             ...
             XeonBotInc.sendMessage(m.chat, button23Messages, { quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'gasm':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/${command}`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonsssMessages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break   
case 'smug2':
...
reply(mess.wait)						
  ...
  headerType: 1
             ...
             XeonBotInc.sendMessage(m.chat, button25Messages, { quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break   
case 'animenom' :
...
if (!m.isGroup) return replay(mess.group)
 ...
 let xxhnekobot = [
  ...
  headerType: 1
            ...
            await XeonBotInc.sendMessage(m.chat, xx1button26Messages, { quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'waifu3':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/waifu`)
      ...
      headerType: 4
             ...
             XeonBotInc.sendMessage(m.chat, button112ssMessages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animecuddle':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/cuddle`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonsosMessages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break   
case 'animeslap':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/slap`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, btutttonssMessages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animepat':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/pat`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, xxbuttonssMessages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animeneko':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/neko`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonsTsMessages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animehug':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/hug`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonussMessages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animekiss':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/kiss`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, bxxuttonssMessages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animewlp':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/wallpaper`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttoxnssMessages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animespank':
...
reply(mess.wait)						
 waifudd = axios.get(`https://nekos.life/api/v2/img/spank`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonssxMessages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animecry':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/cry`)
      ...
      headerType: 4
             ...
             XeonBotInc.sendMessage(m.chat, button1ssxMessages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animekill':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/kill`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsxMessages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animelick':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/lick`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsx12Messages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animebite':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/bite`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsx123Messages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animeyeet':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/yeet`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsx124Messages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animebully':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/lick`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsx125Messages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animebonk':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/bonk`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsx126Messages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animewink':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/wink`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsx127Messages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animepoke':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/poke`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsx128Messages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animesmile':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/smile`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsx129Messages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animewave':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/wave`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsx1210Messages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animeawoo':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/awoo`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsx1211Messages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animeblush':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/blush`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsx1212Messages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animesmug':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/smug`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsx1213Messages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animeglomp':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/glomp`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsx1214Messages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animehappy':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/happy`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsx1215Messages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animedance':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/dance`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsx1216Messages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animecringe':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/cringe`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsx1217Messages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animehighfive':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/highfive`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsx1218Messages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animehandhold':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/handhold`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsx1219Messages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'animemegumin':
...
reply(mess.wait)						
 waifudd = axios.get(`https://api.waifu.pics/sfw/megumin`)
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, buttonszzsx1220Messages,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
case 'shinobu2':  
...
await XeonBotInc.sendMessage(m.chat,buttonsesMessage, { quoted:fkontak3 }).catch(err => {
     return('Error!')
    })               
break
case 'megumin2':
...
await XeonBotInc.sendMessage(m.chat,buttonzMessage, { quoted:fkontak3 }).catch(err => {
     return('Error!')
    })               
break     
case 'awoo2':
...
reply(mess.wait)						
 ...
 var wbuttsss = [
  ...
  headerType: 2
             ...
             XeonBotInc.sendMessage(m.chat, button1Messages, { quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
break
...
var walb = [
      ...
      headerType: 4
            ...
            await XeonBotInc.sendMessage(m.chat, wal,{ quoted:fkontak3 }).catch(err => {
                    return('Error!')
                })
...
XeonBotInc.sendMessage(m.chat, {document: linkyke, mimetype: 'application/zip', fileName: `${anu.result.filename}`}, {quoted:fkontak3}).catch ((err) => reply(mess.error))     
}
break
case 'savefrom': {
if (isBan) return reply(mess.ban)	 			
...
XeonBotInc.sendImage(m.chat, Imgnah, anuuh, fkontak3)
  break
case 'fitnah':
if (!m.isGroup) return replay(mess.group)
...
XeonBotInc.sendMessage(from,{text:te,mentions: [y], },{quoted:fkontak3})
} catch (err) {
...
XeonBotInc.sendImageAsSticker(m.chat, anu, fkontak, { packname: global.packname, author: global.author }).catch((err) => m.reply('Maaf apikey telah mencapai batas.'))
					break
...
*Umur* : ${umur}
*Kisah* : ${kisah}`)	
XeonBotInc.sendImage(m.chat, gambar, kisahnabii, fkontak3)
	}
            break
			case 'kisahmuslim': {
   if (isBan) return reply(mess.ban)	 			
...
*Judul* : ${judul}
*Cerita* : ${cerita}`)	
XeonBotInc.sendImage(m.chat, gambar, kisahnya, fkontak3)
	}
            break
	case 'xytrol': {
	  if (isBan) return reply(mess.ban)	 			
...
teks = "yhaha hayyuk"
XeonBotInc.sendMessage(m.chat, { image : { url : funne }, caption: teks }, { quoted : fkontak3 })
}
break
      case 'rules':
...
XeonBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️ Peringatan ⚠️ 」\`\`\`\n\nFitur Ini Mengandung Fitur +18, Harap Jangan Coli / Colmek Melihat Nya Dan Fitur Ini Mengandung Bug`, contextInfo: { mentionedJid : mems }}, {quoted:fkontak3})
} else if (args[0] === "off") {
...
\n\n*WELCOME\n\n
bugcrot
bugahay `, `${ngazap(prefix)}`, fkontak3)
}
}
break
case 'bugghoib': {
...
XeonBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️ Peringatan ⚠️ 」\`\`\`\n\nFitur Ini Mengandung Fitur Bug Admin Dan Penyapa, Harap Berhati-hati`, contextInfo: { mentionedJid : mems }}, {quoted:fkontak3})
} else if (args[0] === "off") {
...
( Q.S ${res.result.data.surah.name.transliteration.id} : ${res.result.data.number.inSurah} )`
		m.reply(txt)
		XeonBotInc.sendMessage(m.chat, {audio: { url: res.result.data.audio.primary }, mimetype: 'audio/mpeg'}, { quoted : fkontak3 })
		}
		break
		case 'tafsirsurah': {
			if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
		...
		XeonBotInc.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf`}, {quoted:fkontak3}).catch ((err) => m.reply(oh))
		}
		break
case 'alkitab': {
if (isBan) return reply(mess.ban)	 			
...
*Judul* : ${jud}
*Cerita* : ${cer}`)
XeonBotInc.sendImage(m.chat, thumb, cersex, fkontak3)
}
break
case 'cerhantu': {
if (isBan) return reply(mess.ban)	 			
...
*Judul* : ${jud}
*Cerita* : ${cer}`)
XeonBotInc.sendImage(m.chat, thumb, cerhant, fkontak3)
}
break
case 'cerpen': {
if (isBan) return reply(mess.ban)	 			
...
*Location* : ${location}
*Bio* : ${bio}`)
XeonBotInc.sendImage(m.chat, profile, capt, fkontak3)
}
break
case 'jadwalsalat': {
if (isBan) return reply(mess.ban)	 			
...
*Following* : ${follg}
*Description* : ${desc}`)
XeonBotInc.sendImage(m.chat, profile, capk, fkontak3)
}
break
case 'culik':
case 'nyulik':
...
m.reply(mess.wait)
XeonBotInc.sendMessage(m.chat, { video: krt, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `${bugsw}` }, { quoted:fkontak3 })
break
case 'searchgc':
case 'searchgece':
case 'searchgrup':
...
XeonBotInc.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:fkontak3})
} else if (args[0] === 'glow') {
if (args.length < 2) return reply(`Example :\n${prefix + command + ' ' + args[0]} ${global.ownername}`)
...
if (isBanChat) return reply(mess.banChat)
     ...
     console.log(anui)
    XeonBotInc.sendMessage(from, {image:{url:anui}, caption:"Here you go!"}, {quoted:fkontak3})
}
   break
  case 'whitebear':{
  	if (isBan) return reply(mess.ban)	 			
...
console.log(anu)
XeonBotInc.sendMessage(from,{image:{url:anu}, caption:"Here you go!"},{quoted:fkontak3})
}
break
case 'retro':{
	if (isBan) return reply(mess.ban)	 			
...
let mese = await XeonBotInc.sendMessage(m.chat, {image:{url:emoji.images[4].url}, caption: `Made by ${global.botname}`}, {quoted:fkontak3})
await XeonBotInc.sendMessage(from, {text:"reply #s to this image to make sticker"}, {quoted:fkontak3ese})
})
}
break
...
let audio = await toAudio(media, 'mp4')
XeonBotInc.sendMessage(m.chat, {audio: audio, mimetype: 'audio/mpeg'}, { quoted : fkontak3 })
}
break
case 'tomp3': {
   if (isBan) return reply(mess.ban)	 			
...
let { toAudio } = require('./lib/converter')
let audio = await toAudio(media, 'mp4')
XeonBotInc.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Converted By ${XeonBotInc.user.name} (${m.id}).mp3`}, { quoted : fkontak3 })
}
break
...
let audio = await toPTT(media, 'mp4')
XeonBotInc.sendMessage(m.chat, {audio: audio, mimetype:'audio/mpeg', ptt:true }, {quoted:fkontak3})
}
break
case 'togif': {
   if (isBan) return reply(mess.ban)	 			
...
break
	    ...
	    XeonBotInc.sendMessage(m.chat, {image: fs.readFileSync(outputFile), caption: mess.success}, { quoted : fkontak3 })
...
if (isBanChat) return reply(mess.banChat)
if (args[0] === "mp4") {
XeonBotInc.sendMessage(from, {video:{url:args[1]}, caption:'Done!', mimetype:'video/mp4'}, {quoted:fkontak3})
} else if (args[0] === "jpg") {
XeonBotInc.sendMessage(from, {image:{url:args[1]}, caption:'Done!'}, {quoted:fkontak3})
} else {
reply("Error! ")
}
}
...
if (isBanChat) return reply(mess.banChat)
	...
	if (isBanChat) return reply(mess.banChat)
            ...
            XeonBotInc.sendImage(m.chat, thumb, capt, fkontak3)
            }
            break
...
if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
           ...
           linkye = `*APK DOWNLOAD*\n\n*Title:* ${i.title}\n*Updated:* ${i.up}\n*Version:* ${i.vers}\n*Size:* ${i.size}\n*Url:* \n*Desc:* ${i.desc}`         
                ...
                XeonBotInc.sendMessage(m.chat, {document: await getBuffer(i.link), mimetype: `application/vnd.android.package-archive`, fileName: `${i.title}`}, {quoted:fkontak3})  
                }  
                }).catch((err) => {
                    reply(mess.error)
                }) 
...
case 'tagme': {
	if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
XeonBotInc.sendMessage(m.chat, {text:`@${m.sender.split("@")[0]}`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:fkontak3})
}
break
...
${themeemoji} Thumbnail Url: ${mek.thumbnail}`
            XeonBotInc.sendImage(m.chat, gambar, capt, fkontak3)
			}
            break
            case 'animexxx':{
            	   if (isBan) return reply(mess.ban)	 			
...
XeonBotInc.sendMessage(m.chat,{image:{url:result.images.jpg.large_image_url},caption:details},{quoted:fkontak3})   
break
case 'manga':
   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
...
XeonBotInc.sendMessage(m.chat,{image:{url:srh.data[0].images.jpg.large_image_url},caption:mang},{quoted:fkontak3})   
break
            break
case 'lyrics': {
		            	if (isBan) return reply(mess.ban)
...
teks = "\nDarkjokes*"
XeonBotInc.sendMessage(m.chat, { image : { url : res }, caption: teks }, { quoted : fkontak3 })
break
case 'cnn-news':
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
...
teks += "══════════════════"
XeonBotInc.sendMessage(m.chat, { image : { url : res[0].berita_thumb }, caption: teks }, { quoted : fkontak3 })
...
break
	...
	if (isBanChat) return reply(mess.banChat)
            ...
            XeonBotInc.sendImage(m.chat, res.result[0].thumb, capt, fkontak3)
            }
            break
case 'shortstoryx':{
	   if (isBan) return reply(mess.ban)	 			
...
break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                XeonBotInc.sendText(m.chat, `${themeemoji} *Name :* ${anu.message.nama}\n${themeemoji} *Born :* ${anu.message.tgl_lahir}\n${themeemoji} *Lifeline :* ${anu.message.garis_hidup}`, fkontak3)
            }
            break
            case 'keberuntungan': {
            	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                XeonBotInc.sendText(m.chat, `${themeemoji} *Name :* ${anu.message.nama}\n${themeemoji} *Born :* ${anu.message.tgl_lahir}\n${themeemoji} *Results :* ${anu.message.result}`, fkontak3)
            }
            break
            case 'memancing': {
            	   if (isBan) return reply(mess.ban)
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                XeonBotInc.sendText(m.chat, `${themeemoji} *Results :* ${anu.message}`, fkontak3)
            }
            break
			case 'tktoknowm':
			case 'ttnowm':
...
XeonBotInc.sendImage(m.chat, thumbnaill, caption, fkontak3)
	}
            break
case 'ytvd': {
   if (isBan) return reply(mess.ban)	 			
...
break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                XeonBotInc.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `${anu.title}`}, { quoted : fkontak3 }).catch((err) => reply(mess.error))
...
*Link* : ${baby1[0].link}`
reply(`${result4}`)
XeonBotInc.sendMessage(m.chat, { document : { url : baby1[0].link}, fileName : baby1[0].nama, mimetype: baby1[0].mime }, { quoted : fkontak3 }).catch ((err) => reply(mess.error))
}
break
...
XeonBotInc.sendMessage(from, {audio:hah, mimetype:'audio/mp4', ptt:true}, {quoted:fkontak3})
fs.unlinkSync(ran)
})
...
if (err) return reply('Error!')
hah = fs.readFileSync(ran)
XeonBotInc.sendMessage(from, {video:hah, mimetype:'video/mp4'}, {quoted:fkontak3})
fs.unlinkSync(ran)
})
} else {
...
break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                XeonBotInc.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : fkontak3 })
                fs.unlinkSync(ran)
                })
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
                `).trim()
                XeonBotInc.sendImage(m.chat, mekik4, respon, fkontak3)
				await sleep(1500)
	...
	if (isBanChat) return reply(mess.banChat)
        ...
        if (stderr.trim()) reply(stderr)
            ...
            case 'owner': case 'creator': {
                XeonBotInc.sendContact(m.chat, global.vcardowner, fkontak3)
            }
            break
  case 'setmenu': {
            	if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
            ...
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                XeonBotInc.sendListMsg(m.chat, `Please select the menu you want to change!`, ` `, XeonBotInc.user.name, `Click Here`, sections, fkontak3)
                }
            }
            break
case 'request': {
...
for (let i of owner) {
XeonBotInc.sendMessage(i + "@s.whatsapp.net", {text: teks + teks1, mentions:[m.sender]}, {quoted:fkontak3})
}
XeonBotInc.sendMessage(m.chat, {text: teks + teks2 + teks1, mentions:[m.sender]}, {quoted:fkontak3})
}
break
...
XeonBotInc.sendImage(m.chat, mekik3, teksss, fkontak3)
}
break
...
${global.rules}`)
XeonBotInc.sendImage(m.chat, mekik, kocak, fkontak3)
  await sleep(1000)
...
│For helping me adding all of this features
└─────────────┈ ⳹`)
XeonBotInc.sendImage(m.chat, mekik2, kocak2, fkontak3)
await sleep(1000)
...
XeonBotInc.sendReadReceipt(m.chat, m.sender, [m.key.id])
XeonBotInc.sendMessage(from, {sticker:sendNye, contextInfo:{forwardingScore: 800, isForwarded: true}}, {quoted:fkontak3})
}
//anti-tag 3
